...
const emails = [
  "hello@dhruvaldhameliya.com",
  "work@dhruvaldhameliya.com",
  "dhruvalcd@gmail.com",
];
    ...
    <Container>
      ...
      <div className="mt-10 space-y-6">
        ...
        <div>
          ...
          <p className="text-foreground ml-6">Santa Clara, CA (Bay Area)</p>
        </div>
        ...
        <div>
          ...
          <TrackedLink
            ...
            className="text-blue-600 hover:underline dark:text-blue-400 ml-6"
          >
